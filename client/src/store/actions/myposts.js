...
export const SET_MY_POSTS = 'picarus/posts/SET_MY_POSTS';
...
export const setPosts = (posts) => ({ type: SET_MY_POSTS, posts });
...
export const fetchUserPosts = (userId) => async (dispatch) => {
    const response = await fetch(`${backendUrl}/api/users/${userId}/posts`, {
